...
var loggerFormatFunctions map[string]func(*loggerOpt, *f.Request, *f.Response) string = map[string]func(*loggerOpt, *f.Request, *f.Response) string{

	/*
	   Response header content-length.
	*/

	":res[content-length]": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
	...
	*/
	...
	":http-version": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
		return req.Proto
	},
	...
	*/
	...
	":response-time": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
	...
	*/
	...
	":remote-addr": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
	...
	*/
	...
	":date": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
	...
	*/
	...
	":method": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
		return req.Method
	},
	...
	*/
	...
	":url": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
	...
	*/
	...
	":referrer": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
		return req.Referer()
	},
	...
	*/
	...
	":user-agent": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
	...
	*/
	...
	":status": func(opt *loggerOpt, req *f.Request, res *f.Response) string {
...
*/
func Create(o ...interface{}) func(*f.Request, *f.Response, func()) {
...
func loggerFormat(opt loggerOpt, req *f.Request, res *f.Response, format string) string {
...
func loggerFormatDev(opt loggerOpt, req *f.Request, res *f.Response) string {
